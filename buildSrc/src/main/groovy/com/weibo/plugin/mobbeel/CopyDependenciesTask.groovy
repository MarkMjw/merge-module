...
//
//                    project.copy {
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/packaged-classes/"
//                        from("${project.rootDir.path}/${dependency.name}/build/intermediates/packaged-classes/") {
//                            include "${variantName}/**"
//                        }
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/manifests/full/"
//                        from("${project.rootDir.path}/${dependency.name}/build/intermediates/manifests/full/") {
//                            include "${variantName}/**"
//                            exclude "**/output.json"
//                        }
//                        into temporaryDir.path
...
//
//                    project.copy {
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/res/symbol-table-with-package/${variantName}"
//                        from"${project.rootDir.path}/${dependency.name}/build/intermediates/res/symbol-table-with-package/${variantName}"
//                        include "package-aware-r.txt"
//                        rename '(.*)', 'R.txt'
//                        into "${temporaryDir.path}/${variantName}"
//                    }
...
//
//                    project.copy {
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/packaged-aidl/${variantName}"
//                        from "${project.rootDir.path}/${dependency.name}/build/intermediates/packaged-aidl/${variantName}"
//                        include "**"
//                        into "${temporaryDir.path}/${variantName}/aidl"
//                    }
//                    project.copy {
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/packaged_res/${variantName}"
//                        from "${project.rootDir.path}/${dependency.name}/build/intermediates/packaged_res/${variantName}"
//                        include "**"
//                        into "${temporaryDir.path}/${variantName}/res"
//                    }
//                    project.copy {
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/packagedAssets/${variantName}"
//                        from "${project.rootDir.path}/${dependency.name}/build/intermediates/packagedAssets/${variantName}"
//                        include "**"
//                        into "${temporaryDir.path}/${variantName}/assets"
//                    }
//                    project.copy {
//                        println "==== ${project.rootDir.path}/${dependency.name}/build/intermediates/publish-proguard/${variantName}"
//                        from "${project.rootDir.path}/${dependency.name}/build/intermediates/publish-proguard/${variantName}"
//                        include "**"
//                        into "${temporaryDir.path}/${variantName}/"
//                    }
//
